...
private:
  ...
  //   fastDebugFile_ << "  spd=" << std::setw(5) << std::setprecision(2) <<
  //   speed; fastDebugFile_ << "  |  PS0: raw=" << std::setw(6) <<
  //   std::setprecision(0)
...
public:
  ...
  void correctToWall(double targetDistM) {
    ...
    // if (fastDebugFile_.is_open()) {
    //   fastDebugFile_ << "\n--- WALL CORRECTION ---\n";
    //   fastDebugFile_ << "Initial: " << frontDist << "m, Target: " <<
    //   targetDistM
    //                  << "m\n";
    // }
  ...
  void startFastForward() {
    ...
    //     fastDebugFile_ << "Fast drive target: " <<
    //     FastDriveConfig::TARGET_DIST
    //                    << "m\n";
  ...
  bool updateFastForward(double dt) {
    ...
    if (frontDist < FastDriveConfig::WALL_STOP_DIST && frontDist < 1.5) {
      ...
      //   debugFile_ << "Time: " << robot_->getTime() << "s\n";
      //   debugFile_ << "Front distance: " << std::fixed <<
      //   std::setprecision(5)
      //              << frontDist << "m\n";
      ...
      //   FastDriveConfig::WALL_STOP_DIST
      //                  << "m\n";
